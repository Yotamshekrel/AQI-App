...
const AQIdisplay = ({ index, isSecond }) => {
    let color = "grey";
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "squre", style: squareStyle, onMouseEnter: showPopup, onMouseLeave: hidePopup, children: index }), isPopupVisible && _jsx("div", { className: "popup", children: colorInfo })] }));
};
